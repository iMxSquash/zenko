...
export const PROBLEM_DECOR: DecorShape[] = [
  {
    node: 'Group 2',
    parallax: 200,
    src: '/assets/blob_probleme_1.svg',
  ...
  },
  {
    node: 'Group 1',
    parallax: 200,
    src: '/assets/blob_probleme_2.svg',
    style: {
      left: -130,
      bottom: -50,
      width: 367,
  ...
  },
  {
    ...
    behind: true,
    parallax: 300,
    src: '/assets/blob_probleme_4.svg',
  ...
  },
  {
    ...
    behind: true,
    parallax: 300,
    src: '/assets/blob_probleme_3.svg',
    style: { left: 134, top: 100, width: 87, height: 88, transform: 'scaleX(-1)' },
    desktopOnly: true,
  },
];
...
export const SOLUTION_DECOR: DecorShape[] = [
  {
    node: 'Vector 20',
    parallax: 100,
    src: '/assets/blob_solution_1.svg',
  ...
  },
  {
    node: 'Vector 21',
    parallax: 100,
    src: '/assets/blob_solution_2.svg',
  ...
  },
  {
    ...
    behind: true,
    parallax: 250,
    src: '/assets/blob_solution_3.svg',
  ...
  },
  {
    ...
    behind: true,
    parallax: 320,
    src: '/assets/blob_solution_4.svg',
...
export const TESTIMONIALS_DECOR: DecorShape[] = [
  {
    node: 'Vector 21',
    parallax: 100,
    src: '/assets/blob_cta_1.svg',
    style: { left: -350, bottom: -154, width: 596, height: 561 },
    mobileStyle: { left: -280, bottom: -200, width: 596, height: 561 },
  },
  {
    node: 'Vector 22',
    parallax: 100,
    src: '/assets/blob_cta_2.svg',

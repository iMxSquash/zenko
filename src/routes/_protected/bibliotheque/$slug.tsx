          ...
          {fiche && (
            <>
              <div className="flex flex-col gap-2">
                <div
                  className={cn(
                    'self-start rounded-[6px] px-2 py-[3px]',
                ...
                <h1 className="text-[28px] font-bold leading-[36px] tracking-[-0.084px] text-text-primary">
                  {fiche.title}
                </h1>

                <p className="text-[18px] font-normal leading-[28px] text-text-primary">
                  {fiche.description}
                </p>
              </div>
                ...
                <div className="px-24">
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      p: ({ node: _, ...props }) => (
                        <p
                          className="mb-4 text-justify text-[17px] font-normal leading-[24px] text-text-primary last:mb-0"
                          {...props}
                        />
                      ),
                      ul: ({ node: _, ...props }) => (
                        <ul
                          className="mb-4 list-disc pl-6 text-[17px] leading-[24px] text-text-primary"
                          {...props}
                        />
                      ),
                      ol: ({ node: _, ...props }) => (
                        <ol
                          className="mb-4 list-decimal pl-6 text-[17px] leading-[24px] text-text-primary"
                          {...props}
                        />
                      ),

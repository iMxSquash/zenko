        ...
        <div className="flex flex-col gap-8 px-8 py-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[15px] text-text-secondary">
              Fiches pratiques, scripts, vidéos. Tout ce qu'un enseignant peut ouvrir entre deux
              cours et appliquer le lendemain.
            </p>
          </div>
          ...
          <div className="relative flex items-center gap-8 overflow-hidden rounded-card-lg bg-brand p-8">
            ...
            <div className="relative flex flex-1 flex-col gap-4">
              ...
              >
                <span className="text-[14px] font-semibold text-teacher">
